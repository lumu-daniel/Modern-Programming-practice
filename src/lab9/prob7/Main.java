...
public class Main {
	...
	public static void ordering1(List<Integer> list) {
		list.stream().sorted(Comparator.comparing(Math::abs)).forEach(System.out::println);
	}
	...
	public static void ordering2(List<String> words) {
		words.stream().sorted((o1,o2)->new StringBuilder((String)o1).reverse().compareTo(new StringBuilder((String)o2).reverse())).forEach(System.out::println);
	}
